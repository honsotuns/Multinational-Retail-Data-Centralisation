...
class DataExtractor: 
   ...
   ''' This method retrieves the listed number of stores gotten from the API '''   
   ...
   ''' This method gets a json file from AWS s3 '''   
   def sales_date(self):
   ...
   ''' This method calls and instantiate all methods '''
   def run_code(self):
